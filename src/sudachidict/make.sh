...
$__PYTHON convert_sudachidict.py
$__PYTHON ../common/adjust_entries.py mozcdic-ut-sudachidict.txt
if [ "__xxx__$UNCENSOR_UNSUITABLE" != "__xxx__YES" ] ; then
    $__PYTHON ../common/filter_unsuitable_words.py mozcdic-ut-sudachidict.txt
fi
